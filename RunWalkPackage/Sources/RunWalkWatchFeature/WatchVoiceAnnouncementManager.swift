...
/// Manages voice announcements for phase transitions on watchOS
/// Uses the best available system voice for the user's language
/// Keeps announcements minimal - just "Run" or "Walk"
@MainActor
public final class WatchVoiceAnnouncementManager: NSObject {
...
extension WatchVoiceAnnouncementManager: AVSpeechSynthesizerDelegate {
